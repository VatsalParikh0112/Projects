          ...
          <form method="POST" action="code.php">
            <div class="row">
              <div class="form-group col-md-1">
                  <label>ID</label>
                  <input type="text" name="edit_ID" class="form-control" value="<?php echo $row['ID']; ?>" readonly>
              </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
                <label>Gender</label>
                <select class="form-control" name="Gender" value = "<?php echo $row['Gender']; ?>" readonly>
                  <option>Male</option>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="Address2" value = "<?php echo $row['Address2']; ?>" readonly>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label>City</label>
              ...
              <div class="form-group col-md-4">
                <label>State</label>
                <select class="form-control" name="State" value = "<?php echo $row['State']; ?>" readonly>
            ...
            <div class="row">
              <div class="form-group col-md-3">
                ...
                <select class="form-control" name="Refrence" value = "<?php echo $row['Refrence']; ?>" readonly>
              ...
              <div class="form-group col-md-9">
                ...
                <input type="text" class="form-control" name="Feedback" value = "<?php echo $row['Feedback']; ?>" readonly>
              </div>
            </div>
